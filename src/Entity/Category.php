...
class Category
{
     ...
     * @Assert\Length(max=128, maxMessage="El nombre de la categoría no puede superar los {{ limit }} caracteres")
     *
     ...
     *
     * @ORM\Column(name="category_modified_at", type="datetime", nullable=true)
     */
    private $modifiedAt;
